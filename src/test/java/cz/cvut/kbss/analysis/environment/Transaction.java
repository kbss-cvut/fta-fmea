 ...
 *
 * <p>It is required for proper JOPA functionality in tests. The tests cannot function in one
 * transaction like regular JPA-based Spring tests, since JOPA is not able to add pending changes to
 * query results.
 */
public class Transaction {
     ...
     * to see uncommitted transactional changes. So the whole test cannot run in a single
     * transaction, as is common in regular Spring testing.
     *
